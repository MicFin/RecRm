  ...
  def self.generate_for_appointment(appointment, client_or_dietitian)
    ...
    if client_or_dietitian.class == User
      ...
      if appointment_survey.count < 1
        ...
        new_survey.save
        Question.new(position: 1, tier: 1, content: "What are your top THREE nutritional challenges for your child or as an entire family?", question_type: "Response", survey_group: "Pre-Appointment-Client", survey_group_question_id: 1, choices: "", survey_id: new_survey.id).save
        Question.new(position: 2, tier: 2, content: "What is the ONE thing you would really like to accomplish during this session?", question_type: "Response", survey_group: "Pre-Appointment-Client", survey_group_question_id: 2, choices: "", survey_id: new_survey.id).save
        ...
        Question.new(position: 4, tier: 1, content: "Please share any other information that is important to understanding #{appointment.patient_focus.first_name}'s nutrition.", question_type: "Response", survey_group: "Pre-Appointment-Client", survey_group_question_id: 4, choices: "", survey_id: new_survey.id).save
      ...
      if appointment_survey.count < 1
        ...
        Question.new(position: 2, tier: 1, content: "#{appointment.patient_focus.first_name}'s BMI", question_type: "Response", survey_group: "Pre-Appointment-Dietitian", survey_group_question_id: 2, choices: "", survey_id: new_survey.id).save
        Question.new(position: 3, tier: 1, content: "#{appointment.patient_focus.first_name}'s Estimated Energy Requirement(EER)", question_type: "Response", survey_group: "Pre-Appointment-Dietitian", survey_group_question_id: 3, choices: "", survey_id: new_survey.id).save
        Question.new(position: 4, tier: 1, content: "#{appointment.patient_focus.first_name}'s Protein Recommended Daily Allowance (RDA)", question_type: "Response", survey_group: "Pre-Appointment-Dietitian", survey_group_question_id: 4, choices: "", survey_id: new_survey.id).save
        Question.new(position: 5, tier: 1, content: "#{appointment.patient_focus.first_name}'s Fluid Requirement", question_type: "Response", survey_group: "Pre-Appointment-Dietitian", survey_group_question_id: 5, choices: "", survey_id: new_survey.id).save
        Question.new(position: 6, tier: 1, content: "Assessment / Plan", question_type: "Response", survey_group: "Pre-Appointment-Dietitian", survey_group_question_id: 6, choices: "", survey_id: new_survey.id).save
        new_survey.save
      else
        new_survey = appointment_survey.last
      end
