...
//    Full configuation can be found under  http://docs.cksource.com/CKEditor_3.x/Developers_Guide/Toolbar
    ...
    CKEDITOR.config.extraAllowedContent = 'div(*); p(monologue-post-intro-paragraph,heading,monologue-post-note,monologue-post-storage); img(monologue-post-image-center); h2(heading); h4(monologue-post-subcategory); span(heading); ul(list)';
