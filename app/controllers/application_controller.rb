...
private
  ...
  def configure_permitted_parameters
  	if current_dietitian 
	    devise_parameter_sanitizer.for(:sign_up) do |u| u.permit(:first_name, :last_name, :email, :signature, :password, :password_confirmation, :current_password)
	    end
	    devise_parameter_sanitizer.for(:account_update) do |u| u.permit(:first_name, :last_name, :email, :signature, :password, :password_confirmation, :current_password)
	    end
	  end
  end
