...
# https://stackoverflow.com/questions/5918086/format-a-date-in-the-rails-model
DateTime::DATE_FORMATS[:short_birth_date] = "%b %e, %Y"
Date::DATE_FORMATS[:short_birth_date] = "%b %e, %Y"
...
# DateTime
  ...
  #DateTime::DATE_FORMATS[:default] = "%B %e, %Y %l:%M %p" # November 3, 2013 14:22
