  ...
  def self.generate_for_appointment(appointment, client_or_dietitian)
    ...
    if client_or_dietitian.class == User
      ...
      if appointment_survey.count < 1
        ...
        Question.new(position: 5, tier: 1, content: "#{appointment.patient_focus.first_name}'s weight in centimeters", question_type: "Number", survey_group: "Pre-Appointment-Dietitian", survey_group_question_id: 5, choices: "", survey_id: new_survey.id).save
        ...
        Question.new(position: 12, tier: 1, content: "#{appointment.patient_focus.first_name}'s fluid (oz/day)", question_type: "Number", survey_group: "Pre-Appointment-Dietitian", survey_group_question_id: 12, choices: "", survey_id: new_survey.id).save
        Question.new(position: 13, tier: 1, content: "#{appointment.patient_focus.first_name}'s protein RDA (oz/day)", question_type: "Number", survey_group: "Pre-Appointment-Dietitian", survey_group_question_id: 13, choices: "", survey_id: new_survey.id).save
        Question.new(position: 14, tier: 1, content: "#{appointment.patient_focus.first_name}'s protein EAR (oz/day)", question_type: "Number", survey_group: "Pre-Appointment-Dietitian", survey_group_question_id: 14, choices: "", survey_id: new_survey.id).save
        Question.new(position: 15, tier: 1, content: "Assessment / Plan for #{appointment.patient_focus.first_name}", question_type: "Number", survey_group: "Pre-Appointment-Dietitian", survey_group_question_id: 15, choices: "", survey_id: new_survey.id).save
        new_survey.save
      else
        new_survey = appointment_survey.last
      end
