class FoodDiaryEntriesController < ApplicationController
  ...
  # GET /food_diary_entries
  # GET /food_diary_entries.json
  def index
    @food_diary_entries = FoodDiaryEntry.all
  end

  # GET /food_diary_entries/1
  # GET /food_diary_entries/1.json
  def show
  end

  # GET /food_diary_entries/new
  def new
    @food_diary_entry = FoodDiaryEntry.new
  end

  # GET /food_diary_entries/1/edit
  def edit
  end

  # POST /food_diary_entries
  # POST /food_diary_entries.json
  def create
    @food_diary_entry = FoodDiaryEntry.new(food_diary_entry_params)

    respond_to do |format|
      if @food_diary_entry.save
        format.html { redirect_to @food_diary_entry, notice: 'Food diary entry was successfully created.' }
  ...
  # PATCH/PUT /food_diary_entries/1
  # PATCH/PUT /food_diary_entries/1.json
  def update
    respond_to do |format|
      if @food_diary_entry.update(food_diary_entry_params)
        format.html { redirect_to @food_diary_entry, notice: 'Food diary entry was successfully updated.' }
  ...
  # DELETE /food_diary_entries/1
  # DELETE /food_diary_entries/1.json
  def destroy
    @food_diary_entry.destroy
    respond_to do |format|
      format.html { redirect_to food_diary_entries_url, notice: 'Food diary entry was successfully destroyed.' }
